Betul. Kita **ulang dari awal**, tapi sekarang pakai format dokumentasi final yang lebih waras:
...
Bukan gaya “blok panjang sampai terminal ikut capek.” Kita bikin semua file docs dengan format konsisten, supaya nanti Codex/AI tahu batas kerja dan nggak improvisasi macam arsitek mabuk kopi.

# Strategi ulang dari awal

Kita pakai struktur final ini:
...
# Format wajib semua file

Semua file pakai template ini:
...
Explain what this document controls and why it exists.

## 2. Current Context

Explain the current project condition, current stack, current limitations, and current implementation reality.

## 3. Decisions

List architectural/product/technical decisions that are already locked.

## 4. Rules

List rules that must be followed during implementation.

## 5. Implementation Guide

Explain the recommended implementation direction without over-detailing every line of code.

## 6. Anti-Patterns

List things that must not be done.

## 7. Checklist

List items that must be true before this area is considered acceptable.
...
Ini jadi **format baku**. Tidak semua file harus super panjang. Yang penting **tegas, konsisten, dan bisa dipakai AI/Codex sebagai pagar**. Tragis memang, AI juga perlu pagar karena manusia terus meminta AI “gas aja”.
...
Kenapa mulai dari `00-ai-context.md`?

Karena file ini nanti jadi **brief utama buat Codex/AI** sebelum dia baca file lain.

---

# Draft 00-ai-context.md
