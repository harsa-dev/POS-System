...
const checks = [
  ...
  () => assertContains({ label: "internal monitoring contract snapshot", content: files.contractSnapshot, expected: "InternalMonitoringControlRoomDto" }),
  () => assertContains({ label: "internal monitoring contract snapshot", content: files.contractSnapshot, expected: "InternalMonitoringMutationReadinessContractDto" }),
  () => assertContains({ label: "internal monitoring contract snapshot", content: files.contractSnapshot, expected: "Mutation Readiness & Dry-run Contracts" }),
  () => assertFileExists("scripts/platform-admin-contract-parity-check.mjs"),
  () => assertContains({ label: "platform admin contract parity package command", content: files.packageJson, expected: "platform-admin:contract-parity" }),
  ...
  () => assertContains({ label: "contract parity script", content: files.contractParity, expected: "extractTypeBlock" }),
  () => assertContains({ label: "contract parity script", content: files.contractParity, expected: "assertDtoFields" }),
  () => assertContains({ label: "contract parity script", content: files.contractParity, expected: "snapshot.dtoTypes" }),
  () => assertContains({ label: "contract parity script", content: files.contractParity, expected: "snapshot.endpoints" }),
