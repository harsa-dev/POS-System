...
const checks = [
  ...
  () => assertIncludes("plan", plan, "POST /api/internal/admin-console/role-requests"),
  () => assertIncludes("plan", plan, "GET /api/internal/admin-console/roles"),
  ...
  () => assertIncludes("mock", mock, "Admin Role Console"),
  () => assertIncludes("mock", mock, "/api/internal/admin-console/roles"),
  () => assertIncludes("mock", mock, "/api/internal/admin-console/role-requests"),
