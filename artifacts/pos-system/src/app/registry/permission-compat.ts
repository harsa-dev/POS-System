...
export const permissionRoleCompatibility = {
  ...
  "retail.customers.manage": MANAGEMENT_ROLES,
  "retail.returns.manage": MANAGEMENT_ROLES,
  "retail.staff.manage": MANAGEMENT_ROLES,
  "retail.forecasting.view": READ_ONLY_BUSINESS_ROLES,
  "retail.locations.manage": MANAGEMENT_ROLES,
  "retail.omnichannel.manage": MANAGEMENT_ROLES,
  "retail.audit.view": MANAGEMENT_ROLES,
