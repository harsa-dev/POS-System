...
> = {
  privacy: {
    ...
    description: "Draft halaman privasi untuk demo portfolio. Belum legal final, tapi cukup untuk bikin auth flow kelihatan seperti produk serius.",
    icon: ShieldCheck,
    sections: [
      ...
      { title: "Provider pihak ketiga", body: "Google login dan payment provider masih dummy atau tahap awal. Kalau provider asli dipasang, policy ini harus diperbarui." },
      { title: "Status dokumen", body: "Ini placeholder untuk development dan portfolio. Production policy harus direview ulang sebelum dipakai beneran." },
    ],
  },
  terms: {
    eyebrow: "Terms of Service · Dummy Draft",
    title: "Terms of Service",
    description: "Draft syarat penggunaan untuk demo SaaS. Isinya jelas, tapi belum menjadi kontrak hukum final.",
    icon: FileText,
    sections: [
  ...
  cookies: {
    ...
    sections: [
      ...
      { title: "Status dokumen", body: "Ini placeholder UI/legal. Cookie policy final harus mengikuti tool yang benar-benar dipakai." },
    ],
  },
};
          ...
          <div className="grid gap-0 md:grid-cols-[0.95fr_1.05fr]">
            ...
            <div className="p-6 sm:p-8 lg:p-10">
              <div className="mb-8 rounded-3xl border border-amber-200 bg-amber-50 px-5 py-4 text-sm leading-6 text-amber-900">
                <strong>Dummy notice:</strong> halaman ini cuma draft UI/legal copy untuk development. Jangan pakai sebagai dokumen production final.
              </div>
