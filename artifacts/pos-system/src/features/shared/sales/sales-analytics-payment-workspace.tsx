...
import { SalesAnalyticsFilterSyncObserver } from "./sales-analytics-filter-sync-observer";
import { SalesAnalyticsSyncedReconciliationDrilldownPanel } from "./sales-analytics-synced-reconciliation-drilldown-panel";
import { SalesPaymentIntegrityWorkbenchPanel } from "./sales-payment-integrity-workbench-panel";
...
export function SalesAnalyticsPaymentWorkspace() {
  ...
  return (
    <DashboardShell
      ...
      description="Guarded revenue, product performance, source health, reconciliation, and payment integrity workspace."
      icon={BarChart3}
    >
