...
export const ROUTES = {
  ...
  CHECKOUT: "/dashboard/restaurant/server/checkout",
  ORDERS: "/dashboard/restaurant/server/orders",
  ORDER_DETAIL: (id: string) => `/dashboard/restaurant/server/orders/${id}`,
  MENU: "/dashboard/restaurant/menu",
  RECIPES: "/dashboard/restaurant/menu/recipes",
  TABLES: "/dashboard/restaurant/server/tables",
  KDS: "/dashboard/restaurant/kitchen",
  SERVING: "/dashboard/restaurant/server/serving",
  PAYMENTS: "/dashboard/restaurant/server/payments",
