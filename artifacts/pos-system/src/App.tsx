...
import type { PlatformAdminCapability } from "@/components/core/platform-admin/platform-admin-policy";
...
function PlatformAdminProtectedRoute({
  children,
  capability,
}: {
  children: React.ReactNode;
  ...
  return (
    <PlatformAdminRoute user={user} isLoading={isLoading} capability={capability}>
      {children}
    </PlatformAdminRoute>
  );
}
      ...
      <Suspense fallback={<PageFallback />}>
        <Switch>
          ...
          <Route path={ROUTES.INTERNAL_MONITORING}>
            <PlatformAdminProtectedRoute capability="platform-admin.internal-monitoring.read">
