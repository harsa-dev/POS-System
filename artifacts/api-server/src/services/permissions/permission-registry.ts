...
export const permissionKeys = {
  ...
  rawMaterial: {
    ...
    storage: {
      view: "raw-material.storage.view",
      manage: "raw-material.storage.manage",
    },
    intakes: {
    ...
    batches: {
      ...
      manage: "raw-material.batches.manage",
    ...
    processing: {
      ...
      manage: "raw-material.processing.manage",
    },
    stockMovements: {
      view: "raw-material.stock-movements.view",
      create: "raw-material.stock-movements.create",
      adjust: "raw-material.stock-movements.adjust",
      transfer: "raw-material.stock-movements.transfer",
      consume: "raw-material.stock-movements.consume",
    },
    pens: {
  ...
  service: {
    ...
    costs: {
      create: "service.costs.create",
    },
    quotes: {
      view: "service.quotes.view",
      create: "service.quotes.create",
      approve: "service.quotes.approve",
      cancel: "service.quotes.cancel",
    },
    invoices: {
      view: "service.invoices.view",
      create: "service.invoices.create",
      recordPayment: "service.invoices.record-payment",
      reversePayment: "service.invoices.reverse-payment",
...
const rawMaterialOwnerPermissions = [
  ...
  permissionKeys.rawMaterial.storage.view,
  permissionKeys.rawMaterial.storage.manage,
  ...
  permissionKeys.rawMaterial.batches.manage,
  ...
  permissionKeys.rawMaterial.processing.manage,
  permissionKeys.rawMaterial.stockMovements.view,
  permissionKeys.rawMaterial.stockMovements.create,
  permissionKeys.rawMaterial.stockMovements.adjust,
  permissionKeys.rawMaterial.stockMovements.transfer,
  permissionKeys.rawMaterial.stockMovements.consume,
...
const serviceOwnerPermissions = [
  ...
  permissionKeys.service.costs.create,
  permissionKeys.service.quotes.view,
  permissionKeys.service.quotes.create,
  permissionKeys.service.quotes.approve,
  permissionKeys.service.quotes.cancel,
  permissionKeys.service.invoices.view,
  permissionKeys.service.invoices.create,
  permissionKeys.service.invoices.recordPayment,
  permissionKeys.service.invoices.reversePayment,
