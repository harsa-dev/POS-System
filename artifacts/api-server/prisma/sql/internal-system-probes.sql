...
-- This scoped SQL is intentionally executed through prisma db execute, not Prisma migrate history.
-- It stores read-only runtime probe snapshots after the collector is explicitly enabled.
